...
const screenForNames = (arr) => {
  let regex = /^([MD]r|[MD]rs|Ms).\s[A-Z]\w*/g;
...
let biggerThanLuke = (arr) => {
  let mass = 0;
  arr.forEach(character => character.name === 'Luke Skywalker' ? mass = parseInt(character.mass) : 0);
  return arr.filter(character => parseInt(character.mass) > mass).map(result => result.name).join(' - ');
};
...
const detectTicTacToeWin = (board) => {
  ...
  if ((board[0][0] !== '') && board[0][0] === board[1][0] && board[1][0] === board[2][0]) { checkResult = true; }
  else if ((board[0][0] !== '') && board[0][0] === board[1][1] && board[1][1] === board[2][2]) { checkResult = true; }
  else if ((board[0][0] !== '') && board[0][0] === board[0][1] && board[0][1] === board[0][2]) { checkResult = true; }
  else if ((board[0][1] !== '') && board[0][1] === board[1][1] && board[1][1] === board[2][1]) { checkResult = true; }
  else if ((board[0][2] !== '') && board[0][2] === board[1][2] && board[1][2] === board[2][2]) { checkResult = true; }
  else if ((board[0][2] !== '') && board[0][2] === board[1][1] && board[1][1] === board[2][0]) { checkResult = true; }
  else if ((board[1][0] !== '') && board[1][0] === board[1][1] && board[1][1] === board[1][2]) { checkResult = true; }
  else if ((board[2][0] !== '') && board[2][0] === board[2][1] && board[2][1] === board[2][2]) { checkResult = true; }
